...
const GraphState = Annotation.Root({
  ...
  k: Annotation, // number of docs to retrieve
  strategy: Annotation, // simple, complex
  routeReason: Annotation, // 路由原因
  retrievedDocs: Annotation, // 检索到的文档
  localContext: Annotation, // 本地上下文
  webContext: Annotation, // 联网上下文
  evaluation: Annotation, // 评估结果
...
const EvaluateSchema = z.object({
  enough: z.boolean(), // 是否足够回答
  missing: z.array(z.string()).max(6), // 缺失信息点
  reason: z.string(), // 简短原因
  web_query: z.string().optional(), // 联网查询句（可选）
});
