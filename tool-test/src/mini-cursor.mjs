...
async function runAgentWithTools(query, maxIterations = 30){
    const messages = [
        ...
        - 错误实例：{ command: "cd react-todo-app && pnpm install", workingDirectory: "react-todo-app"}
        这是错误的！因为workingDirectory已经在react-todo-app目录了，再 cd react-todo-app 会找不到目录
    ...
    return message[messages.length -1].content
}
